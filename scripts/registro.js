...
fantasia.addEventListener("click", () => {
    fantasia.classList.toggle("seleccionado");
...
romance.addEventListener("click", () => {
    romance.classList.toggle("seleccionado");
...
comedia.addEventListener("click", () => {
    comedia.classList.toggle("seleccionado");
...
nof.addEventListener("click", () => {
    nof.classList.toggle("seleccionado");
...
horror.addEventListener("click", () => {
    horror.classList.toggle("seleccionado");
...
arte.addEventListener("click", () => {
    arte.classList.toggle("seleccionado")
...
misterio.addEventListener("click", () => {
    misterio.classList.toggle("seleccionado")
